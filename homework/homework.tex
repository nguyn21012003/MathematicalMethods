...
\begin{equation}
	\begin{aligned}
		a_{n} & = \evaluated{ -( 12 \theta^{2} - 4 \pi^{2} ) \frac{\sin n \theta}{n^{3}}}_{-\pi}^{\pi} + \int_{-\pi}^{\pi} \frac{\sin n \theta}{n^{3}} 24 \theta d\theta,z
	\end{aligned}
\end{equation}
let
\begin{gather}
...
\begin{equation}
	\begin{aligned}
		\mathcal{F}[ f(\theta) ] & = \frac{8 \pi^{4}}{15} - \sum_{n = 1}^{\infty} \frac{48}{n^{4}} ( -1 )^{n} \cos n\theta.
	\end{aligned}
\end{equation}
...
\begin{equation}
	\begin{aligned}
		a_{n}
		 ...
		 & = \frac{( -1 )^{n}}{2\pi ( 1 + n^{2} )} \left( e^{\pi} - e^{-\pi} \right),
	\end{aligned}
\end{equation}
and
\begin{equation}
	\begin{aligned}
		b_{n}
		 ...
		 & = -\frac{n( -1 )^{n}}{2 \pi ( 1 + n ^{2} )} \left( e^{\pi} - e^{-\pi} \right).
	\end{aligned}
\end{equation}
...
\begin{equation}
	\begin{aligned}
		\mathcal{F} [ e^{\theta} ]
		 & = \frac{1}{2 \pi} ( e^{\pi} - e^{-\pi} ) + \sum_{n = 1}^{\infty} \biggl[ \frac{( -1 )^{n}}{\pi ( 1 + n^{2} )} \left( e^{\pi} - e^{-\pi} \right) \cos n \theta \\
...
\solve{
	...
	\begin{gather}
		\mathcal{F}[ \theta e^{i\theta}] = \frac{a_{0}}{2} + \sum_{n=1}^{\infty} a_{n} \cos n\theta + b_{n} \sin n \theta,
	\end{gather}
	where
	\begin{gather}
	...
	\begin{gather}
		\mathcal{F}[ \theta e^{i\theta} ] = \mathcal{F}[ \theta \cos \theta ] + i\mathcal{F}[ \theta \sin \theta ] .
	\end{gather}
	where
	\begin{gather}
		\mathcal{F}[ \theta \cos \theta ] = \Re[\frac{a_{0}}{2}] + \sum_{n=1}^{\infty} \Re[a_{n}]\cos n \theta + \Re[b_{n}] \sin n \theta,\\
		\mathcal{F}[ \theta \sin \theta ] = \Im[\frac{a_{0}}{2}] + \sum_{n=1}^{\infty} \Im[a_{n}]\cos n \theta + \Im[b_{n}] \sin n \theta.
	\end{gather}
	In particular
	\begin{gather}
		\mathcal{F}[ \theta \cos \theta ] = \sum_{n = 1}^{\infty} \frac{2 \pi n ( -1 )^{n}}{n^{2} - 1} \sin n \theta,
	\end{gather}
	and
	\begin{gather}
		\mathcal{F}[ \theta \sin \theta ] = 2 \pi - \sum_{n = 1}^{\infty} \frac{2 \pi n ( -1 )^{n}}{n^{2} - 1} \cos n \theta.
	\end{gather}
}
\newpage
...
\begin{equation*}
	\begin{aligned}
		...
		\vartheta( x + 1, t )            & = e^{\pi t - 2 \pi i x}\vartheta( x,t ) \\
		\int_{0}^{1} \vartheta( x,t ) dx & = 1.
	\end{aligned}
\end{equation*}
\begin{itemize}
	\item[a)] Using the first condition. Find the Fourier with some unknown.
